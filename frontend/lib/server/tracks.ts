// Server-only: single-track lookups for the billing + streaming routes. The
// /browse catalog read model lives in lib/catalog.ts; this is just the
// per-track fields the meter and stream gate need.
